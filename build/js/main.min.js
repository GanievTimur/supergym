...
var videoInit = function videoInit(selector) {
...
var videoGenerate = function videoGenerate(video) {
  var btn = video.querySelector('.gym__video-button');
  var videoID = btn.dataset.videoId;
  var container = video.querySelector('.gym__video-wrapper');
  btn.addEventListener('click', function () {
    var iframe = iframeGenerate(videoID);
    container.innerHTML = '';
    container.appendChild(iframe);
  });
};
var iframeGenerate = function iframeGenerate(videoID) {
  var iframe = document.createElement('iframe');
  var src = "https://www.youtube.com/embed/".concat(videoID, "?rel=0&showinfo=0&autoplay=1&mute=0");
...
var tabsHeader = tabs.querySelector('.tabs__button-list');
var tabsBody = tabs.querySelector('.tabs__content');
var tabsHeaderNodes = tabs.querySelectorAll('.tabs__button-list > li');
var tabsBodyNodes = tabs.querySelectorAll('.tabs__content > ul');
...
for (var i = 0; i < tabsHeaderNodes.length; i++) {
  _loop(i);
}
